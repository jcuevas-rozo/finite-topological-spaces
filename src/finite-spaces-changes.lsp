...
(DEFMACRO LINE-NUMBER (mtrx)
  #| In order to function 'smith' works |#
  `(nlig ,mtrx))
...
(DEFUN 0NEW-COLUMN (mtrx icol list)
  #| This is in 'New-Smith' (without '0') |#
...
(DEFUN MINIMAL-TERM (matrix begin)
  ...
  (the (values fixnum fixnum fixnum)
    (do ((il (nlig matrix) (1- il))  ; 'line-number' changed by 'nlig'
         (min 0)
         (min-il -1)
         (min-ic -1))
        ((< il begin)
...
(DEFMACRO LINE-OP-5 (mtrx-list lambda line1 line2)
  #| This is in 'New-Smith' |#
  (let ((slambda (gensym)))
    `(let ((,slambda ,lambda))
...
(DEFMACRO COLUMN-OP-5 (mtrx-list lambda column1 column2)
  #| This is in 'New-Smith' |#
  (let ((slambda (gensym)))
    `(let ((,slambda ,lambda))
...
(DEFMACRO LINE-SWAP-5 (mtrx-list line1 line2)
  #| This is in 'New-Smith' |#
  `(progn
...
(DEFMACRO COLUMN-SWAP-5 (mtrx-list column1 column2)
  #| This is in 'New-Smith' |#
  `(progn
...
(DEFMACRO LINE-MINUS-5 (mtrx-list line)
  #| This is in 'New-Smith' |#
  `(progn
...
(DEFMACRO COLUMN-MINUS-5 (mtrx-list column)
  #| This is in 'New-Smith' |#
  `(progn
